...
MorseTable::MorseTable()
{
	...
	string code[37] = {"12", "2111", "2121", "211", "1", "1121", "221", "1111", "11", "1222", "212", "1211", "22", "21", "222", "1221", "2212", "121", "111", "2", "112", "1112", "122", "2112", "2122", "2211", "1222", "11222", "11122", "11112", "11111", "21111", "22111", "22211", "22221", "22222", "00"};
	MorseElement temp;
	for(int i = 0; i < 37; i++)
	{
...
string MorseTable::hashToMorse(char key)
{
//	key = charCertify(key);
	for(int i = 0; i < 37; i++)
	{
...
// char MorseTable::hashToAlpha(string& msg)
// {
// 	for(int i = 0; i < 37; i++)
// 	{
// 		if(table[i].code == msg)
...
queue<string> MorseTable::stream(string msg)
{
	queue<string> trans;
	...
	{
		trans.push(this->hashToMorse(msg[i]));
	}
	return trans;
}
